...
Панель переходного периода из *Cerebro*

Recover paths
~~~~~~~~~~~~~

Замена путей библиотек после переезда из *Cerebro*.
...
* Если поставить галочку ``на утверждение`` то статус задачи изменится на *на утверждение* при этом будет выполнена процедура :ref:`work_panel_check`.
